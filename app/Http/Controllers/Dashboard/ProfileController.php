...
class ProfileController extends Controller
{
    ...
    public function update(Request $request) {
        ...
        foreach (['facebook', 'twitter', 'instagram', 'linkedin', 'youtube'] as $field) {
            if ($request->filled($field) && !preg_match('#^https?://#i', $request->$field)) {
        ...
        $user->tagline = Arr::has($validated, "tagline") ? $validated["tagline"] : $user->tagline;
