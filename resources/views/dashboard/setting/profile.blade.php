                            ...
                            <form action="{{ route("dashboard.settings.profile.update") }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mx-auto">
                                        ...
                                        <div class="form-group">
                                            <label for="tagline">Author Tagline / Role</label>
                                            <input type="text" class="form-control" id="tagline" name="tagline" placeholder="e.g. Cyber Security Researcher, Developer" value="{{ old('tagline', $user->tagline) }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mx-auto">
                                        <div class="form-group">
