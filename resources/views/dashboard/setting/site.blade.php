                ...
                <div class="col-12">
                    ...
                    <div class="card mt-4">
                        <div class="card-header bg-success text-white">
                            <h3 class="card-title"><i class="fas fa-sitemap mr-1"></i> Optimasi SEO & Peta Situs (Sitemap)</h3>
                        </div>
                        <div class="card-body">
                            <p class="text-muted">Generate sitemap statis fisik secara otomatis untuk membantu mesin pencari (Google, Bing) menemukan artikel, halaman, kategori, dan tag terbaru di website Anda.</p>
                            <form action="{{ route('dashboard.settings.sitemap.generate') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-success"><i class="fas fa-sync-alt mr-1"></i> Perbarui Peta Situs Sekarang</button>
                            </form>
                        </div>
                    </div>
                </div>
