    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if (auth()->user()->role == 3)
                <li class="nav-item {{ in_array(request()->route()->getName(), ['dashboard.analytics.overview', 'dashboard.analytics.audience', 'dashboard.analytics.content', 'dashboard.analytics.manage']) ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ in_array(request()->route()->getName(), ['dashboard.analytics.overview', 'dashboard.analytics.audience', 'dashboard.analytics.content', 'dashboard.analytics.manage']) ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('dashboard.analytics.overview') }}" class="nav-link {{ request()->route()->getName() == 'dashboard.analytics.overview' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Overview</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('dashboard.analytics.audience') }}" class="nav-link {{ request()->route()->getName() == 'dashboard.analytics.audience' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Audience</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('dashboard.analytics.content') }}" class="nav-link {{ request()->route()->getName() == 'dashboard.analytics.content' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Content & Search</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ in_array(request()->route()->getName(), ['dashboard.media.index', 'dashboard.media.create', 'dashboard.media.replace', 'dashboard.media.usage']) ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ in_array(request()->route()->getName(), ['dashboard.media.index', 'dashboard.media.create', 'dashboard.media.replace', 'dashboard.media.usage']) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ in_array(request()->route()->getName(), ["dashboard.roadmaps.index", "dashboard.roadmaps.create", "dashboard.roadmaps.edit", "dashboard.roadmaps.builder"]) ? "menu-open" : "" }}">
                    <a href="#" class="nav-link {{ in_array(request()->route()->getName(), ["dashboard.roadmaps.index", "dashboard.roadmaps.create", "dashboard.roadmaps.edit", "dashboard.roadmaps.builder"]) ? "active" : "" }}">
                        <i class="nav-icon fas fa-route"></i>
                        <p>Roadmaps<i class="right fas fa-angle-left"></i>
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route("dashboard.roadmaps.index") }}" class="nav-link {{ request()->route()->getName() == "dashboard.roadmaps.index" ? "active" : "" }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Roadmaps</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("dashboard.roadmaps.create") }}" class="nav-link {{ request()->route()->getName() == "dashboard.roadmaps.create" ? "active" : "" }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Create Roadmap</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ str_starts_with(request()->route()->getName() ?? '', 'dashboard.pages.') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ str_starts_with(request()->route()->getName() ?? '', 'dashboard.pages.') ? 'active' : '' }}">
